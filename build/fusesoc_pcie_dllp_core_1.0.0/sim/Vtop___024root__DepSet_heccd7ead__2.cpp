...
#endif
                VL_FATAL_MT("src/fusesoc_pcie_dllp_core_1.0.0/src/pcie_datalink_layer.sv", 15, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("src/fusesoc_pcie_dllp_core_1.0.0/src/pcie_datalink_layer.sv", 15, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("src/fusesoc_pcie_dllp_core_1.0.0/src/pcie_datalink_layer.sv", 15, "", "NBA region did not converge.");
            }
