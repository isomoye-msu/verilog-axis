...
class pcie_config_reg_TestCase(TestCaseBase): # type: ignore[valid-type,misc]

    def setUp(self) -> None:
        self.dut = pcie_config_reg_cls(callbacks=AsyncCallbackSet(read_callback=read_callback,
...
class pcie_config_reg_TestCase_BlockAccess(TestCaseBase): # type: ignore[valid-type,misc]
...
class pcie_config_reg_TestCase_AltBlockAccess(TestCaseBase): # type: ignore[valid-type,misc]
    """
    ...
    def setUp(self) -> None:
        self.dut = pcie_config_reg_cls(callbacks=AsyncCallbackSetLegacy(
